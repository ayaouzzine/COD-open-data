(function (d3, topojson) {
  ...
  const loadAndProcessData = () =>
    Promise
      .all([
        d3.tsv('https://gist.githubusercontent.com/Kahlaoui-Ismail/00983b311620f50d598db60fc7b4c7d3/raw/9aef529189fe77606db83eb631f98fa8b9828b1c/Renawable2.tsv'),
  ...
  const choroplethMap = (selection, props) => {
    ...
    const countryPaths = g.selectAll('.countryenergie')
      .data(features);
    const countryPathsEnter = countryPaths
      .enter().append('path')
      .attr('class', 'countryenergie');
    countryPaths
    ...
    countryPathsEnter.append('title')
      .text(d => d.properties.name + ': ' + colorinfo(d) + '%');
  };

  const svg = d3.select('#energie');
  ...
  const render = () => {
    colorScale
      ...
      .range(['#AA3377', '#EE6677', '#CCBB44', '#66CCEE', '#4477AA', '#228833', '#BBBBBB']);
